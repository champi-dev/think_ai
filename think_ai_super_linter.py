...
class ThinkAISuperLinter:
    ...
    def lint_directory(self, directory: str) -> Dict[str, Any]:
        ...
        results = {"total_files": 0, "fixed_files": 0, "failed_files": 0, "total_fixes": 0}
        ...
        for root, dirs, files in os.walk(directory):
            ...
            dirs[:] = [
                d
                for d in dirs
                if not d.startswith(".") and d not in ["__pycache__", "node_modules", "venv", "build", "dist"]
            ]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Think AI Super Linter - ¡Dale que vamos tarde! 🇨🇴")
    parser.add_argument("path", nargs="?", default=".", help="Path to lint and fix (file or directory)")
