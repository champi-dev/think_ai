...
impl SelfEvaluator {
    ...
    async fn evaluate_response_quality(
        ...
        let overall_score = relevance_score * 0.25
    ...
    fn calculate_clarity_score(&self, answer: &str) -> f64 {
        ...
        // Clarity scoring
        let word_clarity = if avg_word_length > 8.0 {
            0.5
            1.0 - (avg_word_length - 4.0) / 8.0
        let sentence_clarity = if avg_sentence_length > 20.0 {
            1.0 - (avg_sentence_length - 10.0) / 20.0
        // Bonus for good structure indicators
        let structure_bonus = if answer.contains("First")
    ...
    fn estimate_factual_accuracy(&self, answer: &str) -> f64 {
        ...
        let problematic_count = problematic_patterns
