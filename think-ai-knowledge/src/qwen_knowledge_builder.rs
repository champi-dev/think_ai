...
impl QwenKnowledgeBuilder {
    ...
    async fn build_conversational_patterns(&self) {
        ...
        // Greeting patterns
        let greetings = [("hello", "Hello! I'm Think AI, ready to help you explore any topic. What would you like to know?"),
        ...
        // Help patterns
        let help_patterns = [("help", "I can help you understand topics in science, technology, philosophy, and more. Just ask me anything!"),
