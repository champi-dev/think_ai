...
impl ComponentResponseGenerator {
    ...
    pub fn generate_response_with_memory(
        ...
        // Skip semantic cache logic since we disabled SimpleCacheComponent
            ...
            let has_conversational_match = component_scores.iter().any(|(component, score)| {
                *score >= 0.80
        ...
        let is_simple_conversational = component_scores.iter().any(|(c, s)| {
            *s >= 0.9
...
impl ResponseComponent for ScientificExplanationComponent {
        ...
        let explicit_science = scientific_terms
...
impl ResponseComponent for ConversationalComponent {
        ...
        if query_lower == "greetings" {
            ...
            let responses = ["I'm doing great, thanks for asking! Been learning lots of new things. What about you?",
