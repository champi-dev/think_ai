...
class KnowledgeBridge:
    ...
    def __init__(
        self,
        enhanced_dir: str = "./integrated_knowledge",
        output_dir: str = "../knowledge_files",
    ):
    ...
    def convert_enhanced_knowledge(self):
        ...
        console.print(
            Panel("🔄 Converting Enhanced Knowledge to Think AI Format", style="blue")
        )
        ...
        console.print(
            f"🎉 Conversion completed! Created {len(saved_files)} domain files"
        )
        return True
    ...
    def update_existing_knowledge(self):
        ...
        for file_path in existing_files:
            ...
            try:
                ...
                if (
                    existing_data.get("metadata", {}).get("source")
                    == "enhanced_knowledge"
                ):
                    continue
...
def main():
    ...
    try:
        ...
        console.print(
            Panel(f"❌ Bridge error: {str(e)}", title="Error", style="bold red")
        )
        raise
