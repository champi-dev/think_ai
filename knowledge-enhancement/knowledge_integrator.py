...
class ThinkAIKnowledgeIntegrator:
    ...
    def __init__(self, harvest_dir: str = "./knowledge_harvest", output_dir: str = "./integrated_knowledge"):
    ...
    def _extract_keywords(self, title: str, content: str) -> List[str]:
        ...
        stop_words = {
            ...
            'after', 'beneath', 'under', 'above', 'is', 'are', 'was', 'were',
    ...
    def build_knowledge_structures(self):
        ...
        for cat_stats in category_stats.values():
            cat_stats['avg_confidence'] = cat_stats['total_confidence'] / cat_stats['count']
            cat_stats['sources'] = list(cat_stats['sources'])
            # Get top 10 keywords
            sorted_keywords = sorted(cat_stats['top_keywords'].items(), key=lambda x: x[1], reverse=True)
    ...
    def _save_knowledge_structures(self, category_stats: Dict):
        ...
        with open(self.output_dir / 'knowledge_database.json', 'w', encoding='utf-8') as f:
        ...
        with open(self.output_dir / 'knowledge_indexes.json', 'w', encoding='utf-8') as f:
            json.dump(indexes, f, indent=2)
        
        # Category statistics
        with open(self.output_dir / 'category_statistics.json', 'w', encoding='utf-8') as f:
    ...
    def generate_integration_report(self):
        ...
        avg_confidence = sum(item.confidence for item in self.processed_items) / total_items if total_items > 0 else 0
        ...
        with open(self.output_dir / 'integration_report.json', 'w', encoding='utf-8') as f:
