...
function App() {
  ...
  const playAudioMessage = async (content, messageIndex) => {
    ...
    try {
      ...
      setAudioPlayback(prev => ({ ...prev, [messageIndex]: 'converting' }));
