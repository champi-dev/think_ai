...
from think_ai.utils.progress import progress_context, ModelLoadingProgress
...
async def test_self_training():
    ...
    training_data = [
        ...
        {"query": "What is AI?", "response": "AI is artificial intelligence, computer systems that can perform intelligent tasks."},
        {"query": "Hello", "response": "Hello! How can I help you today?"},
        {"query": "What is a universe?", "response": "The universe is all of space, time, matter, and energy that exists."},
    ]
