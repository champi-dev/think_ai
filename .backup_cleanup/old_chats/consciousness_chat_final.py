...
class FinalConsciousnessChat:
    ...
    async def generate_proper_response(self, query):
        ...
        # Thoughts
        elif "thinking" in query_lower or "thoughts" in query_lower:
        ...
        # Follow-ups
        elif "what is it" in query_lower or "so what" in query_lower:
    ...
    async def run(self):
        ...
        console.print("[yellow]Powered by Qwen 2.5 with exponential intelligence![/yellow]")
