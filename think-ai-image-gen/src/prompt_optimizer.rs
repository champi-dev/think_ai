...
impl PromptOptimizer {
    pub fn new() -> Self {
        ...
        enhancement_patterns.insert("portrait".to_string(), vec![
        ...
        enhancement_patterns.insert("landscape".to_string(), vec![
        ...
        enhancement_patterns.insert("character".to_string(), vec![
            "full body".to_string(),
    ...
    pub async fn optimize(&self, prompt: &str) -> String {
        ...
        for modifier in style_mods.iter() {
            if added_styles >= 2 { // Limit to 2 style modifiers
                break;
            }
    ...
    fn is_style_appropriate(&self, prompt: &str, style: &str) -> bool {
        ...
        match style {
            "photorealistic" | "hyperrealistic" => 
                !prompt.contains("cartoon") && !prompt.contains("anime") && !prompt.contains("illustration"),
            "digital painting" | "concept art" => 
                prompt.contains("fantasy") || prompt.contains("sci-fi") || prompt.contains("character"),
            "cinematic lighting" | "dramatic lighting" => 
                prompt.contains("scene") || prompt.contains("portrait") || prompt.contains("landscape"),
            _ => true,
        }
    }
