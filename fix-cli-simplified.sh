...
echo "Creating simplified version of full-working-o1.rs..."

cd /home/champi/Dev/think_ai

# Create a simpler version that will compile
cat > think-ai-cli/src/bin/full-working-o1.rs << 'EOF'
// Full Working O(1) Think AI System - Simplified version
...
echo "✅ Created simplified version"
echo
