...
class WebappTestSuite:
    ...
    def test_webapp_home(self):
        ...
        try:
            ...
            self.results.append({"test": "Webapp Homepage", "status": "❌ FAIL", "details": str(e)})
            return False
    ...
    def test_api_health(self):
        ...
        try:
            ...
            self.results.append({"test": "API Health Check", "status": "❌ FAIL", "details": str(e)})
            return False
    ...
    def test_api_generate(self):
        ...
        try:
            ...
            self.results.append({"test": "API Generate Endpoint", "status": "❌ FAIL", "details": str(e)})
            return False
    ...
    async def test_websocket(self):
        ...
        try:
            async with websockets.connect(self.ws_url) as websocket:
                # Send a test message
                test_message = json.dumps({"type": "generate", "prompt": "Hello"})
            ...
            self.results.append({"test": "WebSocket Connection", "status": "❌ FAIL", "details": str(e)})
            return False
    ...
    def test_static_assets(self):
        ...
        try:
            ...
            self.results.append({"test": "Static Assets", "status": "❌ FAIL", "details": str(e)})
            return False
    ...
    def test_api_proxy(self):
        ...
        try:
            ...
            self.results.append({"test": "Webapp API Proxy", "status": "❌ FAIL", "details": str(e)})
            return False
