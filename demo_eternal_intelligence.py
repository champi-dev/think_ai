...
def demo():
    ...
    knowledge_items = [
        ...
        ("Best sorting algorithm?", "It depends: QuickSort for average O(n log n), MergeSort for stable sorting, TimSort (Python's default) for real-world data."),
        ("What is consciousness?", "Consciousness is subjective awareness - the experience of being. In AI, we model it through attention and self-reflection.")
    ]
    ...
    interactions = [
        ("How do I learn Python?", "Start with Python.org tutorials, practice on coding platforms, build projects, and read documentation."),
        ("What's the fastest sorting algorithm?", "For general use, QuickSort averages O(n log n). For specific cases: RadixSort for integers, CountingSort for small ranges."),
        ("Explain recursion", "Recursion is when a function calls itself. Base case stops recursion, recursive case breaks problem into smaller parts.")
    ]
    ...
    print(f"  Total Knowledge: {final_stats['total_knowledge']:,} (+{final_stats['total_knowledge'] - initial_stats['total_knowledge']})")
