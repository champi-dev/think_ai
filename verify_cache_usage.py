        ...
        try:
            ...
            if response.status_code == 200:
                ...
                cache_indicators = {
                    ...
                    "specific_content": any(word in ai_response.lower() for word in ["love", "human", "programming", "hello"])
                }
                
                if cache_indicators["very_fast"] and cache_indicators["consistent_length"]:
                    ...
                    print(f"   🔄 LIKELY COMPUTED - Slower response suggests processing")
