...
class PersistentIntelligence:
    ...
    def add_knowledge(self, question: str, answer: str, context: Optional[str] = None, 
            ...
            try:
                ...
                if item_type == "knowledge":
                    conn.execute("""
                        ...
                        VALUES (?, ?, ?, ?, ?, ?)
                    """, (data["timestamp"], data["question"], data["answer"],
                          data["context"], data["confidence"], data["metadata"]))
                    ...
                    """, (data["timestamp"], data["event_type"], 
                          data["content"], data["learning_value"]))
