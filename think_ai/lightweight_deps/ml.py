...
class TransformersLite:
    ...
    class AutoModelForCausalLM:
        ...
        def forward(self, input_ids, **kwargs):
            ...
            return type("Output", (), {"logits": [[0.1] * self.config.get("vocab_size", 50257)], "loss": 0.5})()
    ...
    class Pipeline:
        ...
        def __call__(self, inputs: Union[str, List[str]], **kwargs):
            ...
            if self.task == "text-generation":
                return [
                    {"generated_text": f"{input_} Generated continuation..."}
...
class SentenceTransformersLite:
    ...
    class SentenceTransformer:
        ...
        def encode(self, sentences: Union[str, List[str]], **kwargs) -> List[List[float]]:
            ...
            return [[random.random() for _ in range(self.embedding_dim)] for _ in sentences]
    ...
    class Completion:
        ...
        def create(model: str, prompt: str, **kwargs):
            ...
            return type(
                "Response",
                (),
                {"choices": [type("Choice", (), {"text": "Mock completion text", "finish_reason": "stop"})()]},
            )()
