...
class Collection:
    ...
    def get(
        ...
        **kwargs,
        ...
        if ids:
            ...
            if id in self._data:
                return {"ids": [id], "documents": [self._data[id]], "metadatas": [self._metadata.get(id, {})]}
    ...
    def delete(self, ids: Optional[List[str]] = None, where: Optional[Dict[str, Any]] = None, **kwargs):
...
class Client:
    ...
    def create_collection(
        self, name: str, metadata: Optional[Dict[str, Any]] = None, embedding_function: Optional[Any] = None, **kwargs
    ) -> Collection:
    ...
    def get_collection(self, name: str, embedding_function: Optional[Any] = None, **kwargs) -> Collection:
