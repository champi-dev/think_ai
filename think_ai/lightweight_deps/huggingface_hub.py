...
def hf_hub_download(repo_id: str,
                    filename: str,
...
def list_models(filter: Optional[Union[str, Dict]] = None,
...
def upload_file(path_or_fileobj: Union[str, Path, bytes],
                path_in_repo: str,
                repo_id: str,
                token: Optional[str] = None,
                repo_type: Optional[str] = None,
...
def upload_folder(folder_path: Union[str, Path],
