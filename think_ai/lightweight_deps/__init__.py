...
from .ml import (
    TransformersLite, SentenceTransformersLite, HuggingFaceHubLite,
    OpenAILite, LangChainLite, SpacyLite, generate_embedding, cosine_similarity
)
from .storage import RedisLite, Neo4jLite, CassandraLite, ChromaDBLite
from .web import (
    FastAPIModule, FlaskModule, HttpxLite, AiohttpLite,
    OAuth2PasswordBearer, CORSMiddleware, WebSocketLite, APIRouter
)
from .ui import (
    RichLite, TextualLite, TqdmLite, ClickLite, ColoramaLite
)
from .utils import (
    PsutilLite, PILLite, JoseLite, PasslibLite, PydanticLite,
    SQLAlchemyLite, PlaywrightLite, YAMLLite, DotenvLite
)

__all__ = [
    'LightweightDeps',
    'get_lightweight_import',
    'patch_all_imports',
