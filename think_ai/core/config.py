...
# Use Think AI dependency resolver for dotenv to enable Colombian AI fallbacks
try:
    from dotenv import load_dotenv
except ImportError:
    # Fallback to Think AI's Colombian-enhanced dotenv
    from ..utils.dependency_resolver import dependency_resolver

    dotenv_module = dependency_resolver.resolve_dependency("dotenv")
