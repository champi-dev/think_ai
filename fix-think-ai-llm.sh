...
echo "Fixing unclosed delimiter errors in think-ai-llm.rs..."

cd /home/champi/Dev/think_ai

# Backup the original file
cp think-ai-cli/src/bin/think-ai-llm.rs think-ai-cli/src/bin/think-ai-llm.rs.backup

# Create a properly structured version
cat > think-ai-cli/src/bin/think-ai-llm.rs << 'EOF'
...
echo "✅ Fixed think-ai-llm.rs"
echo
echo "Checking compilation..."
cargo check --bin think-ai-llm 2>&1 | tail -10