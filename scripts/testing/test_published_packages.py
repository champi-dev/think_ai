...
def test_package_install_and_import():
    ...
    try:
        import think_ai_cli
        results["tests"]["import_think_ai_cli"] = {
            "status": "✅ SUCCESS",
            "package": "think-ai-cli"
        }
    ...
    try:
        ...
        if result.returncode == 0:
            results["tests"]["cli_availability"] = {
                "status": "✅ SUCCESS",
...
if __name__ == "__main__":
    ...
    packages_to_install = [
        "think-ai-consciousness==2.1.0",
        "think-ai-cli==0.2.0",
        "o1-vector-search==1.0.0"
    ]
