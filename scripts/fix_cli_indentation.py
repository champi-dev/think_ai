#!/usr/bin/env python3
"""Fix indentation issues in think_ai/cli.py"""


def fix_cli_indentation():
    """Fix the severe indentation issues in cli.py"""

    fixed_content = '''"""Command-line interface for Think AI."""
...
'''
    ...
    with open("think_ai/cli.py", "w") as f:
        f.write(fixed_content)

    print("✅ Fixed cli.py indentation")
