...
class RailwaySimulator:
    ...
    def simulate_nixpacks_build(self) -> Tuple[bool, Optional[str]]:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            shutil.copytree(self.project_root, build_dir, 
    ...
    def _detect_project_type(self) -> str:
        ...
        if (self.project_root / 'package.json').exists():
            return 'node'
             ...
             (self.project_root / 'Pipfile').exists():
            return 'python'
    ...
    def _nixpacks_install_phase(self, build_dir: Path, project_type: str) -> Tuple[bool, Optional[str]]:
        ...
        if project_type == 'python':
            ...
            if not (build_dir / 'package-lock.json').exists() and \
               not (build_dir / 'yarn.lock').exists():
            ...
            for file in files:
                ...
                try:
                    ...
                    if size > 100 * 1024 * 1024:  # 100MB
                        self.warnings.append(f"Large file: {file_path.relative_to(self.project_root)} ({size / 1024 / 1024:.1f}MB)")
                except:
                    pass
    ...
    def _get_project_hash(self) -> str:
        ...
        key_files = [
            'railway.json', 'railway.toml', 'railway.yaml', 'railway.yml',
            'Dockerfile', 'nixpacks.toml', 'requirements.txt', 'package.json',
