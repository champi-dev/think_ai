...
fn main() {
    ...
    if knowledge_files_dir.exists() {
        let ___dynamic_loader = think_ai_knowledge::dynamic_loader::DynamicKnowledgeLoader::new(&knowledge_files_dir);
    ...
    for query in queries {
        ...
        let ___results = knowledge_engine.intelligent_query(query);
