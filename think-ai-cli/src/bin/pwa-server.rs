...
async fn serve_manifest() -> impl IntoResponse {
    let manifest = include_str!("../../../think-ai-webapp/static/manifest.json");
    Response::builder()
...
async fn serve_sw() -> impl IntoResponse {
    let sw = include_str!("../../../think-ai-webapp/static/sw.js");
    Response::builder()
...
async fn chat_handler(
    ...
    let response = state.engine.process(&query.message);
