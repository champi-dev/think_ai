...
use think_ai_knowledge::{
    ...
    training_system::DirectAnswerTrainer,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("✅ Loaded {} knowledge items across {} domains", 
        stats.total_nodes, 
    ...
    let persistence = KnowledgePersistence::new("trained_knowledge")?;
    ...
    println!();
    println!("Knowledge growth rate: {:.2} items/second", 
