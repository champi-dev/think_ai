...
def start_api_server():
    ...
    api_process = subprocess.Popen([sys.executable, "start_with_patch.py"], env=os.environ.copy())
...
def start_webapp():
    ...
    webapp_process = subprocess.Popen(["npm", "start"], cwd=webapp_dir, env=webapp_env)
