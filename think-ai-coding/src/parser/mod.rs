...
pub fn parse_rust_function(code___: &str) -> Result<FunctionInfo, String> {
...
fn extract_function_info(func___: &ItemFn) -> FunctionInfo {
    ...
    let ___return_type = match &func.sig.output {
